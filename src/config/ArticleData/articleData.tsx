...
export const dataSub: IArticleResponse[] = [
  ...
  },
  {
    ...
    category: 'NFL',
    published: '24.05.2023',
    path: '/title/blalsddsddskl23sdskd',
    conference: 'Tenessee',
    team: 'AFC Sout',
    location: 'Italy',
    user: {
  ...
  },
  {
    ...
    path: '/title/blalsddsddsdkl23skd',
    conference: 'Tenessee',
    team: 'AFC Sout',
    location: 'Italy',
    user: {
